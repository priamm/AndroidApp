package com.enecuum.androidapp.ui.view
...
class BottomNavigationViewEx : BottomNavigationView {
    ...
    fun setIconVisibility(visibility: Boolean) {
        ...
        if (!visibility) {
            ...
            if (null != button) {
                ...
                mIcon?.post {
                    //                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
                    itemHeight = mItemHeight - mIcon.measuredHeight
                }
            }
        } else {
     ...
     */
    @JvmOverloads
    fun setupWithViewPager(viewPager: ViewPager?, smoothScroll: Boolean = false) {
        if (mViewPager != null) {
